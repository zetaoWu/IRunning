...
export default class UserInfo extends Component {
    ...
    componentDidMount() {
        ...
        if (this.props.avatarSource) {
            this.setState({
                headUri: this.props.avatarSource,
            });
        }
    }
            ...
            <View style={{backgroundColor: '#FFFFFF', marginTop: 18, height: heightSrc, width: widthSrc}}>
                <View style={{width: widthSrc, height: 35, backgroundColor: '#453d4b'}}>
                    <TouchableOpacity onPress={() => this._backFunction()}>
                        <Image style={{width: 20, height: 20, marginLeft: 15, marginTop: 10}}
                               source={require('../img/backicon.png')} resizeMode='cover'></Image>
                    </TouchableOpacity>
                </View>
                <ScrollView>
                    <View style={{
                        ...
                        <TouchableOpacity onPress={()=>this._picManage()}>
                            <Image style={{width: 80, height: 80, borderRadius: 80, marginTop: 20}}
                                   source={
                                       this.props.avatarSource ? {uri: this.props.avatarSource} : require('../img/head.png')}
                        ...
                        <View style={{
                            ...
                            <Text style={{color: '#D3D3D3', fontSize: 12}}>1 关注 </Text><Text
                            style={{color: '#D3D3D3', fontSize: 12, marginLeft: 10}}>5 粉丝</Text>
                        </View>
                        <Text style={{color: '#FFFFFF', marginTop: 5, fontSize: 12}} onPress={() => this._webView()}>http://xiaowublog.sxl.cn/</Text>
                        <Image style={{marginLeft: 300, width: 17, height: 17, marginTop: 5}}
                               source={require('../img/camera.png')} resizeMode='center'></Image>
                    </View>
                    ...
                    <View style={{
                        ...
                        <View style={{flexDirection: 'row'}}>
                            <Text>665分钟</Text>
                            <Image style={{width: 17, height: 17, marginLeft: 7}} resizeMode='contain'
                                   source={require('../img/jumpto.png')}></Image>
                        </View>
                    </View>
                    ...
                    <View style={{height: 300, width: widthSrc, justifyContent: 'center', alignItems: 'center'}}>
                        <Image style={{width: 60, height: 60, marginTop: 5}} source={require('../img/dongtai.png')}
                        ...
                        <TouchableOpacity onPress={() => this._postDynamic()}>
                            <View style={{
                                ...
                                <Image style={{width: 20, height: 20}} source={require('../img/pen.png')}
                                       resizeMode='center'></Image>
